...
public class GamesDao {
    public static int storedProcedure() {
        ...
        String query = "CALL num_of_games();";
        try {
    ...
    public static boolean insertGame(GameEntity game){
        ...
        Game ormGame = new Game();
        ormGame.setHostClubId(hostClubId);
        ormGame.setGuestClubId(guestClubId);
        ormGame.setStadiumId(stadiumId);
        ormGame.setChampionshipId(championshipId);
        ormGame.setDate(new Date(year,month,day));
        ormGame.setDate(date);
        ormGame.setScore(score);

        session.save(ormGame);
...
//        return executeUpdateQuery(query);
    ...
    public static boolean updateGame(GameEntity game){
        ...
        gameUpdate.setHostClubId(hostClubId);
        gameUpdate.setGuestClubId(guestClubId);
        gameUpdate.setStadiumId(stadiumId);
        gameUpdate.setChampionshipId(championshipId);
//        gameUpdate.setDate(new Date(year,month,day));
        gameUpdate.setDate(date);
        gameUpdate.setScore(score);
...
//        return executeUpdateQuery(query);
    ...
    public static boolean deleteAll(){
        ...
        query = "DELETE FROM matches.championship;";
        executeUpdateQuery(query);

        query = "DELETE FROM matches.club;";
        executeUpdateQuery(query);

        query = "DELETE FROM matches.stadium;";
        executeUpdateQuery(query);
